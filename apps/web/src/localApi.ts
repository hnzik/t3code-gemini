...
export function createLocalApi(rpcClient: WsRpcClient): LocalApi {
  return {
    ...
    server: {
      ...
      importCustomSkill: rpcClient.server.importCustomSkill,
      setCustomSkillEnabled: rpcClient.server.setCustomSkillEnabled,
      removeCustomSkill: rpcClient.server.removeCustomSkill,
